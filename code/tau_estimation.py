...
def run_tau_estimation(group,subj_list,**kwargs):
    ...
    if 'dhcp' in group:
        ...
        root_pth = '/home/annatruzzi/hcp_timecourses/Schaefer/'
    ...
    for i,sub in enumerate(subj_list):
        ...
        if 'dhcp' in group:
            ...
            filename = os.path.join(root_pth,f'{sub}_timeseries_volumetric_perROI.txt')
    ...
    print(alltau.shape)
    np.savetxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/tau_estimation_{group}.txt',alltau)
    ...
    tau_df.to_csv(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/tau_estimation_{group}.csv')
