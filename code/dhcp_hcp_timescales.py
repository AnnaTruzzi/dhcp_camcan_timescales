...
###### TODO: 1. add comparison between snr dhcp and adults in between group comparison (and if no good calculate residuals before comparing in between comparison analysis)  -------HALF DONE
#            2. estimate nan percentage in total and by ROI   


groups_list = ['dhcp_group1','dhcp_group2','hcp']
#controls = ['original','drop_scan_dhcp','global_signal','term_only']
controls = ['original']
...
if run_within_analysis:
    ...
    for control in controls:
        for group in groups_list:
            ...
            mean = np.loadtxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/MEAN_estimation_dhcp_group1_7net_{control}.txt')
            std = np.loadtxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/STD_estimation_dhcp_group1_7net_{control}.txt')
            snr_mean=np.mean(snr,axis=0)
            net_dict = get_net_dict()        
            if 'group1' in group and 'original' in control:
...
if run_between_analysis:
    for control in controls:
        ...
        snr_dhcp1 = np.loadtxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/SNR_estimation_dhcp_group1_7net_{control}.txt')
        snr_dhcp2 = np.loadtxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/SNR_estimation_dhcp_group2_7net_{control}.txt')
        snr_hcp = np.loadtxt(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/SNR_estimation_hcp_7net_{control}.txt')
        ...
        plt.savefig(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/snr_comparison_dhcp1_hcp_7net_{control}.png')
        plt.close()
        ...
        plt.savefig(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/snr_comparison_dhcp2_hcp_7net_{control}.png')
        plt.close()


        correlations.run_and_plot_corr(dhcp_group1_mean,dhcp_group2_mean,'dhcp_group1','dhcp_group2',f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_dhcp1_dhcp2_7net_{control}.png',xlim=(0,8),ylim=(0,8))
        correlations.run_and_plot_partial_corr(dhcp_group1_mean,dhcp_group2_mean,snr_dhcp1_mean,f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/results/partial_corr_dhcp1_dhcp2_snr_7net_{control}.csv')

        correlations.run_and_plot_corr(hcp_mean,dhcp_group1_mean,'hcp','dhcp_group1',f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_dhcp1_hcp_7net_{control}.png',xlim=(0,6),ylim=(0,8))
        correlations.run_and_plot_corr(hcp_mean,dhcp_group2_mean,'hcp','dhcp_group2',f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_dhcp2_hcp_7net_{control}.png',xlim=(0,6),ylim=(0,8))
        correlations.run_and_plot_corr(hcp_mean,dhcp_group1_mean,'hcp','dhcp_group1',f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_dhcp1_hcp_7net_{control}.pdf',xlim=(0,6),ylim=(0,8))
        correlations.run_and_plot_corr(hcp_mean,dhcp_group2_mean,'hcp','dhcp_group2',f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_dhcp2_hcp_7net_{control}.pdf',xlim=(0,6),ylim=(0,8))


        # Corr by net
        correlations.run_and_plot_corr_bynet(hcp_mean,dhcp_group1_mean,'hcp','dhcp_group1',net_dict,xlim=(0,6),ylim=(0,8),flag=control)
        correlations.run_and_plot_corr_bynet(hcp_mean,dhcp_group2_mean,'hcp','dhcp_group2',net_dict,xlim=(0,6),ylim=(0,8),flag=control)
        ...
        unimodal_vs_transmodal(dhcp_group1,hcp,unimodal_index,transmodal_index,'dhcp_group1','hcp',flag=control)
        unimodal_vs_transmodal(dhcp_group2,hcp,unimodal_index,transmodal_index,'dhcp_group2','hcp',flag=control)
