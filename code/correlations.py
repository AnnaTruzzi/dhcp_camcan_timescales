...
def run_and_plot_corr_bynet(x,y,x_label,y_label,net_dict,xlim=(0,15), ylim=(0,15),flag=''):
    for i,net in enumerate(net_dict.keys()):
        ...
        plt.savefig(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_{x_label}_{y_label}_{net}_7net_{flag}.png')
        plt.savefig(f'/dhcp/fmri_anna_graham/dhcp_hcp_timescales/figures/corr_{x_label}_{y_label}_{net}_7net_{flag}.pdf')
        #plt.show()
        plt.close()